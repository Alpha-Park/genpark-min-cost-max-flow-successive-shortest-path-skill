...
[![GitHub stars](https://img.shields.io/github/stars/Alpha-Park/genpark-min-cost-max-flow-successive-shortest-path-skill?style=social)](https://github.com/Alpha-Park/genpark-min-cost-max-flow-successive-shortest-path-skill/stargazers)
...
```bash
git clone https://github.com/Alpha-Park/genpark-min-cost-max-flow-successive-shortest-path-skill.git
